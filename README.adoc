...
image:https://img.shields.io/github/pulls/Luftfartsverket/reqstool-java-maven-plugin?style=for-the-badge&logo=github["GitHub Pulls", link="https://github.com/Luftfartsverket/reqstool-java-maven-plugin/pulls"]
